...
*** COMMENT compile_2_trt.class.py
#+begin_src python :shebang #!/usr/bin/env python3 :results output :mkdirp yes :tangle ./compile_2_trt.class.py
#+end_src
...
#+begin_src emacs-lisp :results silent
  ...
  (async-shell-command "
      './.git.sh'
      git commit -m 'Started writing code for trt and aoti compilers streamlining'
