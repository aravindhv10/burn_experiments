...
** Actual file
#+begin_src conf :tangle ./CMakeLists.txt
  cmake_minimum_required(VERSION 3.18 FATAL_ERROR)
  project(aoti_example)

  find_package(Torch REQUIRED)

  add_executable(aoti_example main.cpp out.pt2)

  add_custom_command(
      OUTPUT out.pt2
      COMMAND python ${CMAKE_CURRENT_SOURCE_DIR}/main.py
      DEPENDS main.py
  )
...
#+begin_src sh :shebang #!/bin/sh :results output :tangle ./compile_g++.sh
  # g++ ./main.cpp -c -o ./main.o -I/usr/include/torch/csrc/api/include/ -laoti_custom_ops -lbackend_with_compiler -lc10 -lgomp-98b21ff3 -ljitbackend_test -lnnapi_backend -lshm -ltorch -ltorch_cpu -ltorch_global_deps -ltorch_python -ltorchbind_test
  g++ ./main.cpp -c -o ./main.o -I/usr/include/torch/csrc/api/include/
  g++ ./main.o -o ./main.exe -laoti_custom_ops -lbackend_with_compiler -lc10 -lgomp-98b21ff3 -ljitbackend_test -lnnapi_backend -lshm -ltorch -ltorch_cpu -ltorch_global_deps -ltorch_python -ltorchbind_test
  # g++ ./main.o -o libmain.so -fPIC -shared
#+end_src
