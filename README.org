...
* Code to export to tensorrt
#+begin_src python :shebang #!/usr/bin/env python3 :results output :mkdirp yes :tangle ./compile_2_trt.py
  import torch
  import torch_tensorrt

  res = torch.export.load("./export.pt2")
...
#+begin_src emacs-lisp :results silent
  ...
  (async-shell-command "
      './.git.sh'
      git commit -m 'Wrote torch to tensorrt compilation scripts'
